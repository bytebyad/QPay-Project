...
import { ChevronLeft, ChevronRight, Download, Search, Clock } from "lucide-react";
    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto  overflow-x-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-green-50 border border-green-200 rounded-lg p-4 mb-6 gap-3 w-full">
                <div className="flex items-start md:items-center gap-3 text-gray-700 text-sm sm:text-base">
                    <Clock className="text-green-700 flex-shrink-0 mt-1 md:mt-0" size={20} />
                    <p className="text-sm sm:text-base">
                        Today’s total collection will be auto-settled by{" "}
                        <span className="font-semibold text-green-800">08:00AM, 23rd Oct’22</span> Tomorrow.
                    </p>
                </div>
                <button className="flex items-center justify-center gap-2 bg-primary text-white px-3 sm:px-5 py-2 rounded-lg shadow hover:bg-green-800 transition text-xs sm:text-sm">
                    <img src={settleImage} alt="Settle Icon" className="w-4 h-4 sm:w-6 sm:h-6" />
                    Settle Now!
                </button>
            </div>
